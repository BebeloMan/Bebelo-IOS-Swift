...
extension MapViewController {
    ...
    func mapView(_ mapView: MGLMapView, didFinishLoading style: MGLStyle) {
        ...
        point.coordinate = self.myLocation//mapView.centerCoordinate
        ...
        if let image = UIImage(named: "Group 21") {
            style.setImage(image, forName: "Group 21")
            
        }
        
        // Tell the layer to use the image in the sprite
        shapeLayer.iconImageName = NSExpression(forConstantValue: "Group 21")
...
//        let camera = GMSCameraPosition.camera(
        ...
        //Mapbox.zoomLevel = Double(zoomLevel)
        //Mapbox.setCenter(myLocation, zoomLevel: Double(zoomLevel), direction: 0, animated: false)
        //        let camera = MGLMapCamera(lookingAtCenter: myLocation, altitude: 4500, pitch: 15, heading: 180)
        //        // Animate the camera movement over 1 seconds.
        //        Mapbox.setCamera(camera, withDuration: 1, animationTimingFunction: CAMediaTimingFunction(name: CAMediaTimingFunctionName.easeInEaseOut))
        
        Mapbox.userTrackingMode = .follow
        Mapbox.showsUserHeadingIndicator = true
...
//    }
    ...
    func showBarDetailInSemiModel() {
        ...
        controller.view.drawOneCorner(corners: [.topLeft,.topRight], radius: 10)
