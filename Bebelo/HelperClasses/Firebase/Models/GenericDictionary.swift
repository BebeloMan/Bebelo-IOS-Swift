...
class GenericDictionary: NSObject {
    ...
    {
        return self.int64ForKey(key: key) ?? 0
    }
    ...
    {
        return self.intForKey(key: key, defaultValue: 1) ?? 0
    }
...
//    }
    ...
    func dictsForKey(key : String) ->[String : Bool]
    {
        return self.dictsForKey(key: key, defaultValue: [:])!
        //        return (dictionary[key] as? [String : Any])!
    }
    
    func dictsForKey(key : String, defaultValue:[String : Bool]?) ->[String : Bool]?
    {
